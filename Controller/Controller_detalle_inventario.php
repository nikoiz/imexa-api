...
class Controller_detalle_inventario
{
    ...
    {
        $query = "SELECT detalle_inventario.nombre_producto as nombre_producto,detalle_inventario.cantidad_producto as cantidad_producto, detalle_inventario.valor as valor FROM `detalle_inventario` WHERE detalle_inventario.id_bodega= ?";
        $stmt = $this->conn->prepare($query);
        //Bind id
